...
export default function AboutPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              VictoryVault exists to level the playing field in American politics by providing conservative candidates
              and causes with the same powerful fundraising tools that have long been available to the left. We believe
              that every American deserves representation that reflects their values, and we're committed to making that
          ...
          <div className="bg-gradient-to-r from-blue-50 to-red-50 rounded-lg p-8">
            <blockquote className="text-xl text-gray-800 italic text-center">
              "Democracy works best when all voices can be heard. VictoryVault ensures that conservative Americans have
              the platform they need to support the leaders who will fight for their values and their future."
            </blockquote>
          </div>
        </div>
      </section>
      ...
      {/* Security & Trust */}
      <section className="py-16 bg-gradient-to-b from-red-400 to-red-500 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Your security and privacy are our top priorities. VictoryVault employs industry-leading security measures
              to protect your personal information and ensure your donations reach their intended recipients.
            </p>
          </div>
