    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-6">
            VictoryVault ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains
            how we collect, use, disclose, and safeguard your information when you visit our website or make a
            contribution through our platform. Please read this privacy policy carefully. If you do not agree with the
          ...
          <p className="mb-6">
            If you have questions or comments about this policy, you may email us at privacy@victoryvault.com or by mail
            to:
          </p>
